export const homeContentVersion = '2026-05-16-premium-roofers-caution-v3';
...
export const homeContentDefaults = {
  ...
  riskText:
    'Pri azbeste nejde len o to, kto ho zloží zo strechy. Dôležité je, ako sa s ním manipuluje, kam sa odvezie a aké doklady po likvidácii dostanete. Pri azbeste nestačí iba demontáž. Dôležité je, aby bol postup riešený legálne pre konkrétnu stavbu - vrátane príslušných podkladov, rozhodnutí a dokladov.',
  riskNoticeTitle: 'Bez dokladov neriskujte',
  riskNoticeText:
    'Pred začiatkom prác si overte, že firma rieši doklady k vašej stavbe. My pripravíme potrebný postup, podania a dokumentáciu v rámci zákazky.',
  cautionEyebrow: 'Na čo si dať pozor pri výbere firmy',
  cautionTitle: 'Na čo si dať pozor pri výbere firmy',
  cautionText:
    'Pri azbeste nie je rozhodujúca iba najnižšia cena. Dôležité je, či firma rieši dokumentáciu, stabilizáciu, kontrolovanú demontáž, balenie, odvoz a doklady.',
  roofersEyebrow: 'Zladenie so strechármi',
  roofersTitle: 'Máte strechára? Zladíme sa. Nemáte? Pomôžeme nájsť.',
  roofersText:
    'Pri výmene strechy rozhoduje načasovanie. Eternit demontujeme tak, aby mohli strechári čo najplynulejšie pokračovať a strecha nezostala zbytočne otvorená.',
  roofersCtaPrimary: 'Nájsť strechára podľa regiónu',
  roofersCtaSecondary: 'Chcem cenovú ponuku',
  ...
  cautionItems:
    'Pýtajte si doklady ku konkrétnej stavbe|Nestačí počuť „máme povolenie“. Pri azbeste má byť riešený zákonný postup pre konkrétnu stavbu. Pred začiatkom prác si vypýtajte doklady k RÚVZ a OÚŽP / životnému prostrediu.\nPozor na odpad ponechaný na dvore|Likvidácia nekončí demontážou. Azbestový odpad musí byť zabalený a odvezený na určené miesto.\nPozor na zhadzovanie eternitu|Materiál sa má demontovať kontrolovane. Zhadzovanie môže zhoršiť riziko prachu, poškodenia a chaosu na stavbe.\nPozor na cenu bez dokladov|Nízka cena môže znamenať, že v nej nie je zahrnutá dokumentácia, skládka, balenie alebo odvoz.\nPozor na meškanie termínu|Ak demontáž mešká, strechári čakajú a strecha môže zostať otvorená. Preto termíny plánujeme vopred a sledujeme počasie.\nPozor na zálohu bez istoty|Pri bežných zákazkách neplatíte vopred za samotnú realizáciu. Platba prebieha po dokončení podľa dohodnutého rozsahu.',
  rooferItems:
